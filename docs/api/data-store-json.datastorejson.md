...
A Veramo agent storage plugin that implements the [IDataStore](./core-types.idatastore.md) and [IDataStoreORM](./core-types.idatastoreorm.md) methods using one big JSON object as a backend.
...
[(constructor)(jsonStore)](./data-store-json.datastorejson._constructor_.md)

</td><td>

</td><td>

**_(BETA)_** Constructs a new instance of the `DataStoreJson` class
...
[methods](./data-store-json.datastorejson.methods.md)
...
[IDataStore](./core-types.idatastore.md) &amp; [IDataStoreORM](./core-types.idatastoreorm.md)
...
[schema](./data-store-json.datastorejson.schema.md)
...
[dataStoreDeleteMessage(args)](./data-store-json.datastorejson.datastoredeletemessage.md)
...
[dataStoreDeleteVerifiableCredential(args)](./data-store-json.datastorejson.datastoredeleteverifiablecredential.md)
...
[dataStoreGetMessage(args)](./data-store-json.datastorejson.datastoregetmessage.md)
...
[dataStoreGetVerifiableCredential(args)](./data-store-json.datastorejson.datastoregetverifiablecredential.md)
...
[dataStoreGetVerifiablePresentation(args)](./data-store-json.datastorejson.datastoregetverifiablepresentation.md)
...
[dataStoreORMGetIdentifiers(args, context)](./data-store-json.datastorejson.datastoreormgetidentifiers.md)
...
[dataStoreORMGetIdentifiersCount(args, context)](./data-store-json.datastorejson.datastoreormgetidentifierscount.md)
...
[dataStoreORMGetMessages(args, context)](./data-store-json.datastorejson.datastoreormgetmessages.md)
...
[dataStoreORMGetMessagesCount(args, context)](./data-store-json.datastorejson.datastoreormgetmessagescount.md)
...
[dataStoreORMGetVerifiableCredentials(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablecredentials.md)
...
[dataStoreORMGetVerifiableCredentialsByClaims(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablecredentialsbyclaims.md)
...
[dataStoreORMGetVerifiableCredentialsByClaimsCount(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablecredentialsbyclaimscount.md)
...
[dataStoreORMGetVerifiableCredentialsCount(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablecredentialscount.md)
...
[dataStoreORMGetVerifiablePresentations(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablepresentations.md)
...
[dataStoreORMGetVerifiablePresentationsCount(args, context)](./data-store-json.datastorejson.datastoreormgetverifiablepresentationscount.md)
...
[dataStoreSaveMessage(args)](./data-store-json.datastorejson.datastoresavemessage.md)
...
[dataStoreSaveVerifiableCredential(args)](./data-store-json.datastorejson.datastoresaveverifiablecredential.md)
...
[dataStoreSaveVerifiablePresentation(args)](./data-store-json.datastorejson.datastoresaveverifiablepresentation.md)
