...
[(constructor)(dbConnection)](./data-store.datastoreorm._constructor_.md)

</td><td>

</td><td>

**_(BETA)_** Constructs a new instance of the `DataStoreORM` class
...
[methods](./data-store.datastoreorm.methods.md)
...
[schema](./data-store.datastoreorm.schema.md)
